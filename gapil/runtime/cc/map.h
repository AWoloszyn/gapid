...
template <typename K, typename V, bool DENSE>
const typename Map<K, V, DENSE>::iterator& Map<K, V, DENSE>::iterator::operator++() {
...
template <typename K, typename V, bool DENSE>
typename Map<K, V, DENSE>::iterator Map<K, V, DENSE>::iterator::operator++(int) {
  iterator ret = *this;
  ++(*this);
  return ret;
}
...
template <typename K, typename V, bool DENSE>
const typename Map<K, V, DENSE>::element& Map<K, V, DENSE>::const_iterator::operator*() {
  return *elem;
}
...
template <typename K, typename V, bool DENSE>
typename Map<K, V, DENSE>::const_iterator& Map<K, V, DENSE>::const_iterator::operator++() {
  size_t offset = elem - reinterpret_cast<element*>(map->elements);
  for (size_t i = offset; i < map->capacity; ++i) {
    ++elem;
    if (i == map->capacity - 1) {
...
template <typename K, typename V, bool DENSE>
typename Map<K, V, DENSE>::const_iterator Map<K, V, DENSE>::const_iterator::operator++(int) {
...
template <typename K, typename V, bool DENSE>
const typename Map<K, V, DENSE>::const_iterator Map<K, V, DENSE>::begin() const {
...
template <typename K, typename V, bool DENSE>
typename Map<K, V, DENSE>::const_iterator Map<K, V, DENSE>::find(const K& k) const {
...
template <typename K, typename V, bool DENSE>
const typename Map<K, V, DENSE>::element* Map<K, V, DENSE>::Allocation::els() const {
